...
import "./LazyMintUpgradeable.sol";
import "@openzeppelin/contracts/proxy/Clones.sol";
import "@openzeppelin/contracts/access/Ownable.sol";

/// @title LazyMintFactoryOptimized
...
contract LazyMintFactoryOptimized is Ownable {
    ...
    function createLazyMint(
        ...
        LazyMintUpgradeable(lazyMintAddress).initialize(
            _uri, 
            _maxSupply, 
            _claimStart,
            _claimEnd,
